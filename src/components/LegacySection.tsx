          ...
          <div className="flex flex-col md:flex-row gap-12 max-w-6xl mx-auto">
            <div className="w-full md:w-1/2 order-2 md:order-1">
              <div className="space-y-12 border-l-2 border-[#c5a059]/30 pl-8 ml-4 md:ml-0 relative">
                ...
                <TimelineItem
                  badge="11"
                  title="Pioneers of Shawarma (2010)"
                  description="In 2010, we introduced Gandhinagar to its very first shawarma - a milestone that quickly became a city favorite. What began as a bold experiment soon turned into a beloved classic, crafted with authentic spices, tender meats, and our signature sauces. This spirit of bringing new flavors to our community continues to guide us. From our humble beginnings to culinary innovations, Dawat has always stood for taste, integrity, and heart."
                />
                <TimelineItem
                  badge="Now"
            ...
            <div className="w-full md:w-1/2 order-1 md:order-2 relative">
              <div className="sticky top-24">
                ...
                {/* Shawarma image aligned with right column visuals */}
                <div className="mt-8 grid grid-cols-1 gap-4 mb-6">
                  <div className="relative group rounded-lg overflow-hidden shadow-2xl">
                    <img
                      src="/images/shawrma/Shawrma.jpg"
                      alt="First Shawarma in Gandhinagar"
                      className="w-full h-[280px] object-cover transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0a192f] via-transparent to-transparent opacity-70"></div>
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      ...
                      <p className="text-xs text-[#c5a059]">
                        Introduced in Gandhinagar (2010)
                      </p>
                    </div>
                  </div>
                </div>
